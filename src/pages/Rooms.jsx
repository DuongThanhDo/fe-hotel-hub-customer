...
const apiRooms = [
    ...
    { name: 'Phong 2 Phong 1 Phong 1Phong 1 ', img: assets.images.rooms, type: '1 giuong doi & 1 giuong doi', price: '200000' },
                    ...
                    {apiRooms.map((room, index) => (
                        <div key={index} className="h-[140px] flex gap-4">
                            ...
                            <div className='flex-1 relative'>
                                ...
                                <p>{room.price} vnđ</p>
                                <Button className='absolute bottom-0 '>Đặt phòng ngay</Button>
                            </div>
                        </div>
                    ))}
                </div>
